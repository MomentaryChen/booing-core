...
> Domain boundary note: merchant visibility/invitation and cross-tenant booking delegation are defined in `doc/specs/done/2026-04-09_domain-visibility-invitation-mvp.md`. This document stays focused on platform user + RBAC management.
