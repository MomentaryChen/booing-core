...
- **Governance rules (repo)**:
  - **PM+Architect joint planning is mandatory** for planning outputs. (Architect feedback is captured in `doc/specs/closed/2026-04-02_mysql-dev-prod-profiles.md`.)
...
- **Status**: **Done (drafted)** — `doc/specs/closed/2026-04-02_mysql-dev-prod-profiles.md`
- **Remaining**:
